...
> 正方形图像矩阵运算公式：  
> 
> <center>$`\binom{x'}{y'}=\begin{bmatrix} 1 & 1 \\ 1 & 2 \\ \end{bmatrix}\binom{x}{y}mod(N)`$</center>
> 
> 多项式运算公式：  
> 
> $$
...
> 
> <center>PSNR\=$`10lg\frac{N^2maxI′(x,y)^2}{∑(I(x,y)−I′(x,y))}  `$ </center>
>   
> <center>NC\=$`\frac{∑W′(u,v)W(u,v)}{∑W(u,v)^2} `$ </center>
>   
> 
